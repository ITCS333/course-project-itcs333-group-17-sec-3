...
//   try {
//     const response = await fetch("auth/api/index.php", { 
//       method: "POST", // must be inside object
//       headers: {
...
//     const data = await response.json(); // store response first

//     if (data.status === "success") {
//       displayMessage("Login successful! Redirecting...", "success");
//       if (data.user.role === "admin") {
//         window.location.href = "admin/api/index.php";
//       } else {
...
async function handleLogin(event) {
  ...
  try {
    const response = await fetch("api/index.php", {  // or absolute path
      method: "POST",
    ...
    if (data.status === "success") {
      ...
      if (data.user.role === "admin") {
        ...
        window.location.href = "/src/student/dashboard.php"; // example
      }
    } else {
      displayMessage(data.message, "error");
    }
...
//         window.location.href = "admin/api/index.php";
//       } else {
//         window.location.href = "student/dashboard.php"; // adjust student path
//       }
